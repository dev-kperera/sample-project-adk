...
# You will now add imports for the Pydantic schema classes
from pydantic import BaseModel, Field

# NOTE: You can define your own Pydantic schema to validate the output of the agent.
...
async def main():
    ...
    root_agent = Agent(
        ...
        #NOTE: When you define an output schema, you cannot use tools or agent transfers.
        disallow_transfer_to_parent=True,
        disallow_transfer_to_peers=True,
        #NOTE: Custom to be generated according to the CountryCapital schema you defined above
